      ...
      <div className="modern-saas-theme">
        ...
        <header className="saas-hero">
          ...
          <p className="saas-hero-subtitle">
            A lightweight, zero-dependency rich text editor built for speed,
            safety, and modularity. Integrates seamlessly with all modern
          ...
          <div className="saas-hero-actions">
            ...
            <a
              href="https://github.com/mindfiredigital/textigniter"
              className="action-btn btn-outline-github"
              target="_blank"
          ...
          <div className="preview-window">
            <div className="window-header">
              ...
              <div className="window-address">
                mindfiredigital.github.io/TextIgniterJS
              </div>
            </div>
            <div className="window-editor-body">
              ...
              >
                {() => {
                        ...
                        class PatchedClass extends OriginalClass {
                          ...
                          connectedCallback() {
                            setTimeout(() => {
                              ...
                              // Clean up any conflicting global IDs in the document from previous/other instances
                              if (typeof document !== "undefined") {
                                document
                                  .querySelectorAll(
                                    "#editor-container, #editor, #toolbar, #popup-toolbar",
                                  )
                                  .forEach((el) => {
                                    if (!this.contains(el)) {
                                      el.remove();
                  ...
                  const {
                    Textigniter,
                  } = require("@mindfiredigital/textigniter-react");
                  return (
                    <Textigniter config={config} initialValue={initialValue} />
                  );
                }}
              </BrowserOnly>
            </div>
        ...
        <section className="features-showcase">
          <div className="section-header">
            ...
            <p>
              Every feature optimized for file size, security, and developer
              control.
            </p>
          </div>
          ...
          <div className="ti-features-grid">
            <div className="ti-feature-card">
              ...
              <h3>🚀 Under 30KB Bundle</h3>
              <p>
                Ensure instant page loads and 100/100 Lighthouse performance
                scores. Perfect for lightweight applications.
              </p>
            </div>
            ...
            <div className="ti-feature-card">
              ...
              <p>
                Written in pure TypeScript with standard browser Web APIs. Say
                goodbye to third-party vulnerability audits.
              </p>
            </div>
            ...
            <div className="ti-feature-card">
              ...
              <p>
                No complex theme engines. Fully configure and style the toolbar,
                editor, and popups using vanilla CSS rules.
              </p>
            </div>
            ...
            <div className="ti-feature-card">
              ...
              <p>
                Comes with table editors, grid layout presets, custom emoji
                drawers, text-to-speech, and LaTeX math builders.
              </p>
            </div>
          </div>
        </section>
        ...
        <footer className="saas-footer">
          <div className="footer-wrap">
            ...
            <p className="copyright-label">
              &copy; {new Date().getFullYear()} Mindfire Digital. All rights
              reserved.
            </p>
          </div>
        </footer>
